    ...
    options: {
        ...
        appTemplates: {
            ...
            settings: {
                ...
                SELKIES_CLIPBOARD_IN_ENABLED: { label: "Enable Client-to-Server Clipboard", description: "Allow clipboard data to be transferred from the browser." },
                SELKIES_CLIPBOARD_OUT_ENABLED: { label: "Enable Server-to-Client Clipboard", description: "Allow clipboard data to be transferred from the server." },
                ...
                SELKIES_FORCE_ALIGNED_RESOLUTION: { label: "Force Aligned Resolution", description: "Forces the display resolution to be a multiple of 16 pixels." },
                ...
                DOCKER_PRIVILEGED: { label: "Privileged Mode", description: "Give all caps to container, lift cgroup restrictions, mounts all host devices. This will break things!" },
                DOCKER_BIND_MOUNTS: { label: "Extra Bind Mounts", description: "Extra host binds (comma separated, e.g., /host/path:/container/path:ro)." },
                DOCKER_ENV: { label: "Environment Variables", description: "Extra environment variables (comma separated, e.g., KEY=VALUE,KEY2=VALUE2)." },
                DOCKER_CAP_ADD: { label: "Cap Add", description: "Add kernel capabilities (comma separated, e.g., SYS_ADMIN,MKNOD)." },
                DOCKER_CAP_DROP: { label: "Cap Drop", description: "Drop kernel capabilities (comma separated)." },
                DOCKER_SECURITY_OPT: { label: "Security Options", description: "Security options (comma separated, e.g., seccomp=unconfined,apparmor=unconfined)." },
                DOCKER_DEVICES: { label: "Devices", description: "Expose host devices (comma separated, e.g., /dev/sda:/dev/xvda:rwm)." },
                DOCKER_SHM_SIZE: { label: "SHM Size", description: "Size of /dev/shm (e.g. 1G, 2G)." },
                DOCKER_MEM_LIMIT: { label: "Memory Limit", description: "Memory limit (e.g. 1g, 512m)." },
                DOCKER_CPU_SHARES: { label: "CPU Shares", description: "CPU shares (relative weight integer)." },
                DOCKER_NANO_CPUS: { label: "Nano CPUs", description: "CPU quota in units of 1e-9 CPUs." },
                DOCKER_NETWORK_MODE: { label: "Network Mode", description: "Networking mode for the container.", options: { default: "Default (Bridge)", host: "Host", none: "None", bridge: "Bridge" } },
                DOCKER_IPC_MODE: { label: "IPC Mode", description: "Set the IPC mode for the container.", options: { default: "Default", host: "Host", private: "Private", shareable: "Shareable" } },
                DOCKER_PID_MODE: { label: "PID Mode", description: "Set the PID mode for the container.", options: { default: "Default", host: "Host" } },
                DOCKER_DNS: { label: "DNS Servers", description: "Custom DNS servers (comma separated)." },
                DOCKER_EXTRA_HOSTS: { label: "Extra Hosts", description: "Host to IP mappings (comma separated, e.g., hostname:1.2.3.4)." },
                DOCKER_SYSCTLS: { label: "Sysctls", description: "Kernel parameters (comma separated, e.g., net.ipv4.ip_forward=1)." },
                DOCKER_ULIMITS: { label: "Ulimits", description: "Ulimits (comma separated, e.g., nofile=1024:1024)." },
                DOCKER_TMPFS: { label: "Tmpfs Mounts", description: "Temporary filesystems (comma separated, e.g., /run:rw,noexec,nosuid,size=65536k)." },
                DOCKER_GROUP_ADD: { label: "Group Add", description: "List of additional group names and/or IDs (comma separated)." },
            }
        },
        appLaboratory: {
        ...
        modals: {
            ...
            generalTitle: 'General & Performance Settings',
            dockerTitle: 'Docker Advanced Overrides',
            dockerDescription: 'These settings override the default container configuration. Use with caution and only if you know what you are doing.',
        },
        status: {
    ...
    options: {
        ...
        appTemplates: {
            ...
            settings: {
                ...
                SELKIES_CLIPBOARD_IN_ENABLED: { label: "Habilitar portapapeles de cliente a servidor", description: "Permitir la transferencia de datos del portapapeles desde el navegador." },
                SELKIES_CLIPBOARD_OUT_ENABLED: { label: "Habilitar portapapeles de servidor a cliente", description: "Permitir la transferencia de datos del portapapeles desde el servidor." },
                ...
                SELKIES_FORCE_ALIGNED_RESOLUTION: { label: "Forzar resolución alineada", description: "Fuerza la resolución de pantalla para que sea un múltiplo de 16 píxeles." },
                ...
                DOCKER_PRIVILEGED: { label: "Modo Privilegiado", description: "Dar todos los permisos al contenedor, levantar restricciones cgroup, montar todos los dispositivos host. ¡Esto romperá cosas!" },
                DOCKER_BIND_MOUNTS: { label: "Montajes de Enlace Extra", description: "Enlaces de host extra (separados por comas, ej., /ruta/host:/ruta/contenedor:ro)." },
                DOCKER_ENV: { label: "Variables de Entorno", description: "Variables de entorno extra (separadas por comas, ej., CLAVE=VALOR,CLAVE2=VALOR2)." },
                DOCKER_CAP_ADD: { label: "Añadir Cap", description: "Añadir capacidades del kernel (separadas por comas, ej., SYS_ADMIN,MKNOD)." },
                DOCKER_CAP_DROP: { label: "Soltar Cap", description: "Soltar capacidades del kernel (separadas por comas)." },
                DOCKER_SECURITY_OPT: { label: "Opciones de Seguridad", description: "Opciones de seguridad (separadas por comas, ej., seccomp=unconfined,apparmor=unconfined)." },
                DOCKER_DEVICES: { label: "Dispositivos", description: "Exponer dispositivos del host (separados por comas, ej., /dev/sda:/dev/xvda:rwm)." },
                DOCKER_SHM_SIZE: { label: "Tamaño SHM", description: "Tamaño de /dev/shm (ej. 1G, 2G)." },
                DOCKER_MEM_LIMIT: { label: "Límite de Memoria", description: "Límite de memoria (ej. 1g, 512m)." },
                DOCKER_CPU_SHARES: { label: "Cuotas de CPU", description: "Cuotas de CPU (entero de peso relativo)." },
                DOCKER_NANO_CPUS: { label: "Nano CPUs", description: "Cuota de CPU en unidades de 1e-9 CPUs." },
                DOCKER_NETWORK_MODE: { label: "Modo de Red", description: "Modo de red para el contenedor.", options: { default: "Por Defecto (Bridge)", host: "Host", none: "Ninguno", bridge: "Bridge" } },
                DOCKER_IPC_MODE: { label: "Modo IPC", description: "Establecer el modo IPC para el contenedor.", options: { default: "Por Defecto", host: "Host", private: "Privado", shareable: "Compartible" } },
                DOCKER_PID_MODE: { label: "Modo PID", description: "Establecer el modo PID para el contenedor.", options: { default: "Por Defecto", host: "Host" } },
                DOCKER_DNS: { label: "Servidores DNS", description: "Servidores DNS personalizados (separados por comas)." },
                DOCKER_EXTRA_HOSTS: { label: "Hosts Extra", description: "Mapeos de Host a IP (separados por comas, ej., hostname:1.2.3.4)." },
                DOCKER_SYSCTLS: { label: "Sysctls", description: "Parámetros del kernel (separados por comas, ej., net.ipv4.ip_forward=1)." },
                DOCKER_ULIMITS: { label: "Ulimits", description: "Ulimits (separados por comas, ej., nofile=1024:1024)." },
                DOCKER_TMPFS: { label: "Montajes Tmpfs", description: "Sistemas de archivos temporales (separados por comas, ej., /run:rw,noexec,nosuid,size=65536k)." },
                DOCKER_GROUP_ADD: { label: "Añadir Grupo", description: "Lista de nombres y/o IDs de grupos adicionales (separados por comas)." },
            }
        },
        appLaboratory: {
        ...
        modals: {
            ...
            generalTitle: 'Configuración General y de Rendimiento',
            dockerTitle: 'Anulaciones Avanzadas de Docker',
            dockerDescription: 'Estas configuraciones anulan la configuración predeterminada del contenedor. Úselas con precaución y solo si sabe lo que está haciendo.',
        },
        status: {
    ...
    options: {
        ...
        appTemplates: {
            ...
            settings: {
                ...
                SELKIES_CLIPBOARD_IN_ENABLED: { label: "启用客户端到服务器剪贴板", description: "允许从浏览器传输剪贴板数据。" },
                SELKIES_CLIPBOARD_OUT_ENABLED: { label: "启用服务器到客户端剪贴板", description: "允许从服务器传输剪贴板数据。" },
                ...
                SELKIES_FORCE_ALIGNED_RESOLUTION: { label: "强制对齐分辨率", description: "强制显示分辨率为 16 像素的倍数." },
                ...
                DOCKER_PRIVILEGED: { label: "特权模式", description: "赋予容器所有权限，解除cgroup限制，挂载所有主机设备。这可能会破坏系统！" },
                DOCKER_BIND_MOUNTS: { label: "额外绑定挂载", description: "额外的绑定挂载（逗号分隔，例如 /host/path:/container/path:ro）。" },
                DOCKER_ENV: { label: "环境变量", description: "额外的环境变量（逗号分隔，例如 KEY=VALUE,KEY2=VALUE2）。" },
                DOCKER_CAP_ADD: { label: "添加能力 (Cap Add)", description: "添加内核能力（逗号分隔，例如 SYS_ADMIN,MKNOD）。" },
                DOCKER_CAP_DROP: { label: "删除能力 (Cap Drop)", description: "删除内核能力（逗号分隔）。" },
                DOCKER_SECURITY_OPT: { label: "安全选项", description: "安全选项（逗号分隔，例如 seccomp=unconfined,apparmor=unconfined）。" },
                DOCKER_DEVICES: { label: "设备", description: "暴露主机设备（逗号分隔，例如 /dev/sda:/dev/xvda:rwm）。" },
                DOCKER_SHM_SIZE: { label: "SHM 大小", description: "/dev/shm 的大小（例如 1G, 2G）。" },
                DOCKER_MEM_LIMIT: { label: "内存限制", description: "内存限制（例如 1g, 512m）。" },
                DOCKER_CPU_SHARES: { label: "CPU 份额", description: "CPU 份额（相对权重整数）。" },
                DOCKER_NANO_CPUS: { label: "Nano CPUs", description: "以 1e-9 CPU 为单位的 CPU 配额。" },
                DOCKER_NETWORK_MODE: { label: "网络模式", description: "容器的网络模式。", options: { default: "默认 (Bridge)", host: "Host", none: "无", bridge: "Bridge" } },
                DOCKER_IPC_MODE: { label: "IPC 模式", description: "设置容器的 IPC 模式。", options: { default: "默认", host: "Host", private: "私有", shareable: "可共享" } },
                DOCKER_PID_MODE: { label: "PID 模式", description: "设置容器的 PID 模式。", options: { default: "默认", host: "Host" } },
                DOCKER_DNS: { label: "DNS 服务器", description: "自定义 DNS 服务器（逗号分隔）。" },
                DOCKER_EXTRA_HOSTS: { label: "额外主机", description: "主机到 IP 的映射（逗号分隔，例如 hostname:1.2.3.4）。" },
                DOCKER_SYSCTLS: { label: "Sysctls", description: "内核参数（逗号分隔，例如 net.ipv4.ip_forward=1）。" },
                DOCKER_ULIMITS: { label: "Ulimits", description: "Ulimits（逗号分隔，例如 nofile=1024:1024）。" },
                DOCKER_TMPFS: { label: "Tmpfs 挂载", description: "临时文件系统（逗号分隔，例如 /run:rw,noexec,nosuid,size=65536k）。" },
                DOCKER_GROUP_ADD: { label: "添加组", description: "附加组名称和/或 ID 的列表（逗号分隔）。" },
            }
        },
        appLaboratory: {
            title: '应用实验室',
        ...
        modals: {
            ...
            generalTitle: '常规与性能设置',
            dockerTitle: 'Docker 高级覆盖',
            dockerDescription: '这些设置覆盖默认的容器配置。请谨慎使用，除非您知道自己在做什么。',
        },
        status: {
            loggingIn: '登录中...',
            configSaved: '配置保存成功！',
    ...
    options: {
        ...
        appTemplates: {
            ...
            settings: {
                ...
                SELKIES_CLIPBOARD_IN_ENABLED: { label: "क्लाइंट-टू-सर्वर क्लिपबोर्ड सक्षम करें", description: "ब्राउज़र से क्लिपबोर्ड डेटा स्थानांतरित करने की अनुमति दें।" },
                SELKIES_CLIPBOARD_OUT_ENABLED: { label: "सर्वर-टू-क्लाइंट क्लिपबोर्ड सक्षम करें", description: "सर्वर से क्लिपबोर्ड डेटा स्थानांतरित करने की अनुमति दें।" },
                ...
                SELKIES_FORCE_ALIGNED_RESOLUTION: { label: "संरेखित रिज़ॉल्यूशन बाध्य करें", description: "डिस्प्ले रिज़ॉल्यूशन को 16 पिक्सल का गुणज होने के लिए बाध्य करता है." },
                ...
                DOCKER_PRIVILEGED: { label: "विशेषाधिकार प्राप्त मोड", description: "कंटेनर को सभी कैप्स दें, cgroup प्रतिबंध हटाएं, सभी होस्ट डिवाइस माउंट करें। इससे चीजें टूट जाएंगी!" },
                DOCKER_BIND_MOUNTS: { label: "अतिरिक्त बाइंड माउंट", description: "अतिरिक्त होस्ट बाइंड (अल्पविराम से अलग, उदा., /host/path:/container/path:ro)।" },
                DOCKER_ENV: { label: "पर्यावरण चर", description: "अतिरिक्त पर्यावरण चर (अल्पविराम से अलग, उदा., KEY=VALUE,KEY2=VALUE2)।" },
                DOCKER_CAP_ADD: { label: "कैप जोड़ें", description: "कर्नेल क्षमताएं जोड़ें (अल्पविराम से अलग, उदा., SYS_ADMIN,MKNOD)।" },
                DOCKER_CAP_DROP: { label: "कैप छोड़ें", description: "कर्नेल क्षमताएं छोड़ें (अल्पविराम से अलग)।" },
                DOCKER_SECURITY_OPT: { label: "सुरक्षा विकल्प", description: "सुरक्षा विकल्प (अल्पविराम से अलग, उदा., seccomp=unconfined,apparmor=unconfined)।" },
                DOCKER_DEVICES: { label: "उपकरण", description: "होस्ट डिवाइस उजागर करें (अल्पविराम से अलग, उदा., /dev/sda:/dev/xvda:rwm)।" },
                DOCKER_SHM_SIZE: { label: "SHM आकार", description: "/dev/shm का आकार (उदा. 1G, 2G)।" },
                DOCKER_MEM_LIMIT: { label: "मेमोरी सीमा", description: "मेमोरी सीमा (उदा. 1g, 512m)।" },
                DOCKER_CPU_SHARES: { label: "CPU शेयर", description: "CPU शेयर (सापेक्ष भार पूर्णांक)।" },
                DOCKER_NANO_CPUS: { label: "नैनो CPU", description: "1e-9 CPU की इकाइयों में CPU कोटा।" },
                DOCKER_NETWORK_MODE: { label: "नेटवर्क मोड", description: "कंटेनर के लिए नेटवर्किंग मोड।", options: { default: "डिफ़ॉल्ट (ब्रिज)", host: "होस्ट", none: "कोई नहीं", bridge: "ब्रिज" } },
                DOCKER_IPC_MODE: { label: "IPC मोड", description: "कंटेनर के लिए IPC मोड सेट करें।", options: { default: "डिफ़ॉल्ट", host: "होस्ट", private: "निजी", shareable: "साझा करने योग्य" } },
                DOCKER_PID_MODE: { label: "PID मोड", description: "कंटेनर के लिए PID मोड सेट करें।", options: { default: "डिफ़ॉल्ट", host: "होस्ट" } },
                DOCKER_DNS: { label: "DNS सर्वर", description: "कस्टम DNS सर्वर (अल्पविराम से अलग)।" },
                DOCKER_EXTRA_HOSTS: { label: "अतिरिक्त होस्ट", description: "होस्ट से IP मैपिंग (अल्पविराम से अलग, उदा., hostname:1.2.3.4)।" },
                DOCKER_SYSCTLS: { label: "Sysctls", description: "कर्नेल पैरामीटर (अल्पविराम से अलग, उदा., net.ipv4.ip_forward=1)।" },
                DOCKER_ULIMITS: { label: "Ulimits", description: "Ulimits (अल्पविराम से अलग, उदा., nofile=1024:1024)।" },
                DOCKER_TMPFS: { label: "Tmpfs माउंट", description: "अस्थायी फाइल सिस्टम (अल्पविराम से अलग, उदा., /run:rw,noexec,nosuid,size=65536k)।" },
                DOCKER_GROUP_ADD: { label: "समूह जोड़ें", description: "अतिरिक्त समूह नामों और/या आईडी की सूची (अल्पविराम से अलग)।" },
            }
        },
        appLaboratory: {
            title: 'ऐप प्रयोगशाला',
        ...
        modals: {
            ...
            generalTitle: 'सामान्य और प्रदर्शन सेटिंग्स',
            dockerTitle: 'डॉकर उन्नत ओवरराइड',
            dockerDescription: 'ये सेटिंग्स डिफ़ॉल्ट कंटेनर कॉन्फ़िगरेशन को ओवरराइड करती हैं। सावधानी से उपयोग करें और केवल तभी जब आप जानते हों कि आप क्या कर रहे हैं।',
        },
        status: {
    ...
    options: {
        ...
        appTemplates: {
            ...
            settings: {
                ...
                SELKIES_CLIPBOARD_IN_ENABLED: { label: "Ativar área de transferência cliente-servidor", description: "Permitir a transferência de dados da área de transferência a partir do navegador." },
                SELKIES_CLIPBOARD_OUT_ENABLED: { label: "Ativar área de transferência servidor-cliente", description: "Permitir a transferência de dados da área de transferência a partir do servidor." },
                ...
                SELKIES_FORCE_ALIGNED_RESOLUTION: { label: "Forçar Resolução Alinhada", description: "Força a resolução da tela a ser um múltiplo de 16 pixels." },
                ...
                DOCKER_PRIVILEGED: { label: "Modo Privilegiado", description: "Dar todas as permissões ao contêiner, remover restrições cgroup, montar todos os dispositivos host. Isso vai quebrar coisas!" },
                DOCKER_BIND_MOUNTS: { label: "Montagens de Ligação Extras", description: "Ligações de host extras (separadas por vírgula, ex: /host/path:/container/path:ro)." },
                DOCKER_ENV: { label: "Variáveis de Ambiente", description: "Variáveis de ambiente extras (separadas por vírgula, ex: KEY=VALUE,KEY2=VALUE2)." },
                DOCKER_CAP_ADD: { label: "Adicionar Cap", description: "Adicionar capacidades do kernel (separadas por vírgula, ex: SYS_ADMIN,MKNOD)." },
                DOCKER_CAP_DROP: { label: "Remover Cap", description: "Remover capacidades do kernel (separadas por vírgula)." },
                DOCKER_SECURITY_OPT: { label: "Opções de Segurança", description: "Opções de segurança (separadas por vírgula, ex: seccomp=unconfined,apparmor=unconfined)." },
                DOCKER_DEVICES: { label: "Dispositivos", description: "Expor dispositivos do host (separados por vírgula, ex: /dev/sda:/dev/xvda:rwm)." },
                DOCKER_SHM_SIZE: { label: "Tamanho SHM", description: "Tamanho de /dev/shm (ex: 1G, 2G)." },
                DOCKER_MEM_LIMIT: { label: "Limite de Memória", description: "Limite de memória (ex: 1g, 512m)." },
                DOCKER_CPU_SHARES: { label: "Cotas de CPU", description: "Cotas de CPU (inteiro de peso relativo)." },
                DOCKER_NANO_CPUS: { label: "Nano CPUs", description: "Cota de CPU em unidades de 1e-9 CPUs." },
                DOCKER_NETWORK_MODE: { label: "Modo de Rede", description: "Modo de rede para o contêiner.", options: { default: "Padrão (Bridge)", host: "Host", none: "Nenhum", bridge: "Bridge" } },
                DOCKER_IPC_MODE: { label: "Modo IPC", description: "Definir o modo IPC para o contêiner.", options: { default: "Padrão", host: "Host", private: "Privado", shareable: "Compartilhável" } },
                DOCKER_PID_MODE: { label: "Modo PID", description: "Definir o modo PID para o contêiner.", options: { default: "Padrão", host: "Host" } },
                DOCKER_DNS: { label: "Servidores DNS", description: "Servidores DNS personalizados (separados por vírgula)." },
                DOCKER_EXTRA_HOSTS: { label: "Hosts Extras", description: "Mapeamentos de Host para IP (separados por vírgula, ex: hostname:1.2.3.4)." },
                DOCKER_SYSCTLS: { label: "Sysctls", description: "Parâmetros do kernel (separados por vírgula, ex: net.ipv4.ip_forward=1)." },
                DOCKER_ULIMITS: { label: "Ulimits", description: "Ulimits (separados por vírgula, ex: nofile=1024:1024)." },
                DOCKER_TMPFS: { label: "Montagens Tmpfs", description: "Sistemas de arquivos temporários (separados por vírgula, ex: /run:rw,noexec,nosuid,size=65536k)." },
                DOCKER_GROUP_ADD: { label: "Adicionar Grupo", description: "Lista de nomes e/ou IDs de grupos adicionais (separados por vírgula)." },
            }
        },
        appLaboratory: {
        ...
        modals: {
            ...
            generalTitle: 'Configurações Gerais e de Desempenho',
            dockerTitle: 'Sobrescritas Avançadas do Docker',
            dockerDescription: 'Essas configurações substituem a configuração padrão do contêiner. Use com cuidado e apenas se souber o que está fazendo.',
        },
        status: {
    ...
    options: {
        ...
        appTemplates: {
            ...
            settings: {
                ...
                SELKIES_CLIPBOARD_IN_ENABLED: { label: "Activer le presse-papiers client vers serveur", description: "Autoriser le transfert des données du presse-papiers depuis le navigateur." },
                SELKIES_CLIPBOARD_OUT_ENABLED: { label: "Activer le presse-papiers serveur vers client", description: "Autoriser le transfert des données du presse-papiers depuis le serveur." },
                ...
                SELKIES_FORCE_ALIGNED_RESOLUTION: { label: "Forcer la résolution alignée", description: "Force la résolution d'affichage à être un multiple de 16 pixels." },
                ...
                DOCKER_PRIVILEGED: { label: "Mode Privilégié", description: "Donner toutes les capacités au conteneur, lever les restrictions cgroup, monter tous les périphériques hôtes. Cela va casser des choses !" },
                DOCKER_BIND_MOUNTS: { label: "Montages Bind Supplémentaires", description: "Liaisons d'hôtes supplémentaires (séparées par des virgules, ex: /host/path:/container/path:ro)." },
                DOCKER_ENV: { label: "Variables d'Environnement", description: "Variables d'environnement supplémentaires (séparées par des virgules, ex: KEY=VALUE,KEY2=VALUE2)." },
                DOCKER_CAP_ADD: { label: "Ajout de Capacité", description: "Ajouter des capacités du noyau (séparées par des virgules, ex: SYS_ADMIN,MKNOD)." },
                DOCKER_CAP_DROP: { label: "Retrait de Capacité", description: "Supprimer des capacités du noyau (séparées par des virgules)." },
                DOCKER_SECURITY_OPT: { label: "Options de Sécurité", description: "Options de sécurité (séparées par des virgules, ex: seccomp=unconfined,apparmor=unconfined)." },
                DOCKER_DEVICES: { label: "Périphériques", description: "Exposer des périphériques hôtes (séparés par des virgules, ex: /dev/sda:/dev/xvda:rwm)." },
                DOCKER_SHM_SIZE: { label: "Taille SHM", description: "Taille de /dev/shm (ex: 1G, 2G)." },
                DOCKER_MEM_LIMIT: { label: "Limite de Mémoire", description: "Limite de mémoire (ex: 1g, 512m)." },
                DOCKER_CPU_SHARES: { label: "Parts CPU", description: "Parts CPU (entier de poids relatif)." },
                DOCKER_NANO_CPUS: { label: "Nano CPUs", description: "Quota CPU en unités de 1e-9 CPUs." },
                DOCKER_NETWORK_MODE: { label: "Mode Réseau", description: "Mode réseau pour le conteneur.", options: { default: "Défaut (Bridge)", host: "Hôte", none: "Aucun", bridge: "Bridge" } },
                DOCKER_IPC_MODE: { label: "Mode IPC", description: "Définir le mode IPC pour le conteneur.", options: { default: "Défaut", host: "Hôte", private: "Privé", shareable: "Partageable" } },
                DOCKER_PID_MODE: { label: "Mode PID", description: "Définir le mode PID pour le conteneur.", options: { default: "Défaut", host: "Hôte" } },
                DOCKER_DNS: { label: "Serveurs DNS", description: "Serveurs DNS personnalisés (séparés par des virgules)." },
                DOCKER_EXTRA_HOSTS: { label: "Hôtes Supplémentaires", description: "Mappages Hôte vers IP (séparés par des virgules, ex: hostname:1.2.3.4)." },
                DOCKER_SYSCTLS: { label: "Sysctls", description: "Paramètres du noyau (séparés par des virgules, ex: net.ipv4.ip_forward=1)." },
                DOCKER_ULIMITS: { label: "Ulimits", description: "Ulimits (séparés par des virgules, ex: nofile=1024:1024)." },
                DOCKER_TMPFS: { label: "Montages Tmpfs", description: "Systèmes de fichiers temporaires (séparés par des virgules, ex: /run:rw,noexec,nosuid,size=65536k)." },
                DOCKER_GROUP_ADD: { label: "Ajout de Groupe", description: "Liste de noms et/ou d'ID de groupes supplémentaires (séparés par des virgules)." },
            }
        },
        appLaboratory: {
        ...
        modals: {
            ...
            generalTitle: 'Paramètres Généraux et de Performance',
            dockerTitle: 'Surcharges Avancées Docker',
            dockerDescription: 'Ces paramètres remplacent la configuration par défaut du conteneur. À utiliser avec prudence et seulement si vous savez ce que vous faites.',
        },
        status: {
    ...
    options: {
        ...
        appTemplates: {
            ...
            settings: {
                ...
                SELKIES_CLIPBOARD_IN_ENABLED: { label: "Включить буфер обмена от клиента к серверу", description: "Разрешить передачу данных буфера обмена из браузера." },
                SELKIES_CLIPBOARD_OUT_ENABLED: { label: "Включить буфер обмена от сервера к клиенту", description: "Разрешить передачу данных буфера обмена с сервера." },
                ...
                SELKIES_FORCE_ALIGNED_RESOLUTION: { label: "Принудительное выравнивание разрешения", description: "Принудительно делает разрешение экрана кратным 16 пикселям." },
                ...
                DOCKER_PRIVILEGED: { label: "Привилегированный режим", description: "Дать все права контейнеру, снять ограничения cgroup, монтировать все устройства хоста. Это может нарушить работу!" },
                DOCKER_BIND_MOUNTS: { label: "Дополнительные Bind Mounts", description: "Дополнительные привязки хоста (через запятую, например, /host/path:/container/path:ro)." },
                DOCKER_ENV: { label: "Переменные окружения", description: "Дополнительные переменные окружения (через запятую, например, KEY=VALUE,KEY2=VALUE2)." },
                DOCKER_CAP_ADD: { label: "Добавить Cap", description: "Добавить возможности ядра (через запятую, например, SYS_ADMIN,MKNOD)." },
                DOCKER_CAP_DROP: { label: "Убрать Cap", description: "Убрать возможности ядра (через запятую)." },
                DOCKER_SECURITY_OPT: { label: "Параметры безопасности", description: "Параметры безопасности (через запятую, например, seccomp=unconfined,apparmor=unconfined)." },
                DOCKER_DEVICES: { label: "Устройства", description: "Проброс устройств хоста (через запятую, например, /dev/sda:/dev/xvda:rwm)." },
                DOCKER_SHM_SIZE: { label: "Размер SHM", description: "Размер /dev/shm (например, 1G, 2G)." },
                DOCKER_MEM_LIMIT: { label: "Лимит памяти", description: "Лимит памяти (например, 1g, 512m)." },
                DOCKER_CPU_SHARES: { label: "Доли ЦП", description: "Доли ЦП (относительный вес, целое число)." },
                DOCKER_NANO_CPUS: { label: "Nano CPU", description: "Квота ЦП в единицах 1e-9 ЦП." },
                DOCKER_NETWORK_MODE: { label: "Режим сети", description: "Сетевой режим для контейнера.", options: { default: "По умолчанию (Bridge)", host: "Host", none: "Нет", bridge: "Bridge" } },
                DOCKER_IPC_MODE: { label: "Режим IPC", description: "Установить режим IPC для контейнера.", options: { default: "По умолчанию", host: "Host", private: "Private", shareable: "Shareable" } },
                DOCKER_PID_MODE: { label: "Режим PID", description: "Установить режим PID для контейнера.", options: { default: "По умолчанию", host: "Host" } },
                DOCKER_DNS: { label: "DNS-серверы", description: "Пользовательские DNS-серверы (через запятую)." },
                DOCKER_EXTRA_HOSTS: { label: "Дополнительные хосты", description: "Сопоставления хостов и IP (через запятую, например, hostname:1.2.3.4)." },
                DOCKER_SYSCTLS: { label: "Sysctls", description: "Параметры ядра (через запятую, например, net.ipv4.ip_forward=1)." },
                DOCKER_ULIMITS: { label: "Ulimits", description: "Ulimits (через запятую, например, nofile=1024:1024)." },
                DOCKER_TMPFS: { label: "Монтирование Tmpfs", description: "Временные файловые системы (через запятую, например, /run:rw,noexec,nosuid,size=65536k)." },
                DOCKER_GROUP_ADD: { label: "Добавить группу", description: "Список дополнительных имен и/или ID групп (через запятую)." },
            }
        },
        appLaboratory: {
        ...
        modals: {
            ...
            generalTitle: 'Общие настройки и производительность',
            dockerTitle: 'Расширенные переопределения Docker',
            dockerDescription: 'Эти настройки переопределяют конфигурацию контейнера по умолчанию. Используйте с осторожностью и только если понимаете, что делаете.',
        },
        status: {
    ...
    options: {
        ...
        appTemplates: {
            ...
            settings: {
                ...
                SELKIES_CLIPBOARD_IN_ENABLED: { label: "Zwischenablage Client-zu-Server aktivieren", description: "Übertragung von Zwischenablagedaten vom Browser erlauben." },
                SELKIES_CLIPBOARD_OUT_ENABLED: { label: "Zwischenablage Server-zu-Client aktivieren", description: "Übertragung von Zwischenablagedaten vom Server erlauben." },
                ...
                SELKIES_FORCE_ALIGNED_RESOLUTION: { label: "Ausgerichtete Auflösung erzwingen", description: "Erzwingt, dass die Bildschirmauflösung ein Vielfaches von 16 Pixeln ist." },
                ...
                DOCKER_PRIVILEGED: { label: "Privilegierter Modus", description: "Alle Rechte an Container geben, Cgroup-Beschränkungen aufheben, alle Host-Geräte mounten. Dies wird Dinge beschädigen!" },
                DOCKER_BIND_MOUNTS: { label: "Zusätzliche Bind-Mounts", description: "Zusätzliche Host-Bindungen (kommagetrennt, z.B. /host/path:/container/path:ro)." },
                DOCKER_ENV: { label: "Umgebungsvariablen", description: "Zusätzliche Umgebungsvariablen (kommagetrennt, z.B. KEY=VALUE,KEY2=VALUE2)." },
                DOCKER_CAP_ADD: { label: "Cap Add", description: "Kernel-Fähigkeiten hinzufügen (kommagetrennt, z.B. SYS_ADMIN,MKNOD)." },
                DOCKER_CAP_DROP: { label: "Cap Drop", description: "Kernel-Fähigkeiten entfernen (kommagetrennt)." },
                DOCKER_SECURITY_OPT: { label: "Sicherheitsoptionen", description: "Sicherheitsoptionen (kommagetrennt, z.B. seccomp=unconfined,apparmor=unconfined)." },
                DOCKER_DEVICES: { label: "Geräte", description: "Host-Geräte freigeben (kommagetrennt, z.B. /dev/sda:/dev/xvda:rwm)." },
                DOCKER_SHM_SIZE: { label: "SHM Größe", description: "Größe von /dev/shm (z.B. 1G, 2G)." },
                DOCKER_MEM_LIMIT: { label: "Speicherlimit", description: "Speicherlimit (z.B. 1g, 512m)." },
                DOCKER_CPU_SHARES: { label: "CPU-Anteile", description: "CPU-Anteile (relatives Gewicht als Ganzzahl)." },
                DOCKER_NANO_CPUS: { label: "Nano CPUs", description: "CPU-Quote in Einheiten von 1e-9 CPUs." },
                DOCKER_NETWORK_MODE: { label: "Netzwerkmodus", description: "Netzwerkmodus für den Container.", options: { default: "Standard (Bridge)", host: "Host", none: "Keine", bridge: "Bridge" } },
                DOCKER_IPC_MODE: { label: "IPC-Modus", description: "Den IPC-Modus für den Container festlegen.", options: { default: "Standard", host: "Host", private: "Privat", shareable: "Teilbar" } },
                DOCKER_PID_MODE: { label: "PID-Modus", description: "Den PID-Modus für den Container festlegen.", options: { default: "Standard", host: "Host" } },
                DOCKER_DNS: { label: "DNS-Server", description: "Benutzerdefinierte DNS-Server (kommagetrennt)." },
                DOCKER_EXTRA_HOSTS: { label: "Zusätzliche Hosts", description: "Host-zu-IP-Zuordnungen (kommagetrennt, z.B. hostname:1.2.3.4)." },
                DOCKER_SYSCTLS: { label: "Sysctls", description: "Kernel-Parameter (kommagetrennt, z.B. net.ipv4.ip_forward=1)." },
                DOCKER_ULIMITS: { label: "Ulimits", description: "Ulimits (kommagetrennt, z.B. nofile=1024:1024)." },
                DOCKER_TMPFS: { label: "Tmpfs Mounts", description: "Temporäre Dateisysteme (kommagetrennt, z.B. /run:rw,noexec,nosuid,size=65536k)." },
                DOCKER_GROUP_ADD: { label: "Gruppe hinzufügen", description: "Liste zusätzlicher Gruppennamen und/oder IDs (kommagetrennt)." },
            }
        },
        appLaboratory: {
            title: 'App-Labor',
        ...
        modals: {
            ...
            generalTitle: 'Allgemein & Leistungseinstellungen',
            dockerTitle: 'Docker Erweiterte Überschreibungen',
            dockerDescription: 'Diese Einstellungen überschreiben die Standard-Containerkonfiguration. Verwenden Sie sie mit Vorsicht und nur, wenn Sie wissen, was Sie tun.',
        },
        status: {
    ...
    options: {
        ...
        appTemplates: {
            ...
            settings: {
                ...
                SELKIES_CLIPBOARD_IN_ENABLED: { label: "İstemciden Sunucuya Panoyu Etkinleştir", description: "Tarayıcıdan pano verilerinin aktarılmasına izin ver." },
                SELKIES_CLIPBOARD_OUT_ENABLED: { label: "Sunucudan İstemciye Panoyu Etkinleştir", description: "Sunucudan pano verilerinin aktarılmasına izin ver." },
                ...
                SELKIES_FORCE_ALIGNED_RESOLUTION: { label: "Hizalanmış Çözünürlüğü Zorla", description: "Ekran çözünürlüğünün 16 pikselin katı olmasını zorlar." },
                ...
                DOCKER_PRIVILEGED: { label: "Ayrıcalıklı Mod", description: "Konteynere tüm yetkileri ver, cgroup kısıtlamalarını kaldır, tüm ana cihazları bağla. Bu bir şeyleri bozabilir!" },
                DOCKER_BIND_MOUNTS: { label: "Ekstra Bağlama Bağlantıları", description: "Ekstra ana bilgisayar bağlantıları (virgülle ayrılmış, örn. /host/path:/container/path:ro)." },
                DOCKER_ENV: { label: "Ortam Değişkenleri", description: "Ekstra ortam değişkenleri (virgülle ayrılmış, örn. KEY=VALUE,KEY2=VALUE2)." },
                DOCKER_CAP_ADD: { label: "Cap Ekle", description: "Çekirdek yetenekleri ekle (virgülle ayrılmış, örn. SYS_ADMIN,MKNOD)." },
                DOCKER_CAP_DROP: { label: "Cap Kaldır", description: "Çekirdek yetenekleri kaldır (virgülle ayrılmış)." },
                DOCKER_SECURITY_OPT: { label: "Güvenlik Seçenekleri", description: "Güvenlik seçenekleri (virgülle ayrılmış, örn. seccomp=unconfined,apparmor=unconfined)." },
                DOCKER_DEVICES: { label: "Cihazlar", description: "Ana bilgisayar cihazlarını göster (virgülle ayrılmış, örn. /dev/sda:/dev/xvda:rwm)." },
                DOCKER_SHM_SIZE: { label: "SHM Boyutu", description: "/dev/shm boyutu (örn. 1G, 2G)." },
                DOCKER_MEM_LIMIT: { label: "Bellek Sınırı", description: "Bellek sınırı (örn. 1g, 512m)." },
                DOCKER_CPU_SHARES: { label: "CPU Payları", description: "CPU payları (göreli ağırlık tam sayısı)." },
                DOCKER_NANO_CPUS: { label: "Nano CPU'lar", description: "1e-9 CPU biriminde CPU kotası." },
                DOCKER_NETWORK_MODE: { label: "Ağ Modu", description: "Konteyner için ağ modu.", options: { default: "Varsayılan (Bridge)", host: "Host", none: "Yok", bridge: "Bridge" } },
                DOCKER_IPC_MODE: { label: "IPC Modu", description: "Konteyner için IPC modunu ayarla.", options: { default: "Varsayılan", host: "Host", private: "Özel", shareable: "Paylaşılabilir" } },
                DOCKER_PID_MODE: { label: "PID Modu", description: "Konteyner için PID modunu ayarla.", options: { default: "Varsayılan", host: "Host" } },
                DOCKER_DNS: { label: "DNS Sunucuları", description: "Özel DNS sunucuları (virgülle ayrılmış)." },
                DOCKER_EXTRA_HOSTS: { label: "Ekstra Hostlar", description: "Host - IP eşleşmeleri (virgülle ayrılmış, örn. hostname:1.2.3.4)." },
                DOCKER_SYSCTLS: { label: "Sysctls", description: "Çekirdek parametreleri (virgülle ayrılmış, örn. net.ipv4.ip_forward=1)." },
                DOCKER_ULIMITS: { label: "Ulimits", description: "Ulimits (virgülle ayrılmış, örn. nofile=1024:1024)." },
                DOCKER_TMPFS: { label: "Tmpfs Bağlantıları", description: "Geçici dosya sistemleri (virgülle ayrılmış, örn. /run:rw,noexec,nosuid,size=65536k)." },
                DOCKER_GROUP_ADD: { label: "Grup Ekle", description: "Ek grup adları ve/veya kimlikleri listesi (virgülle ayrılmış)." },
            }
        },
        appLaboratory: {
        ...
        modals: {
            ...
            generalTitle: 'Genel ve Performans Ayarları',
            dockerTitle: 'Docker Gelişmiş Geçersiz Kılmalar',
            dockerDescription: 'Bu ayarlar varsayılan konteyner yapılandırmasını geçersiz kılar. Dikkatli kullanın ve yalnızca ne yaptığınızı biliyorsanız kullanın.',
        },
        status: {
    ...
    options: {
        ...
        appTemplates: {
            ...
            settings: {
                ...
                SELKIES_CLIPBOARD_IN_ENABLED: { label: "Abilita appunti da client a server", description: "Consenti il trasferimento dei dati degli appunti dal browser." },
                SELKIES_CLIPBOARD_OUT_ENABLED: { label: "Abilita appunti da server a client", description: "Consenti il trasferimento dei dati degli appunti dal server." },
                ...
                SELKIES_FORCE_ALIGNED_RESOLUTION: { label: "Forza risoluzione allineata", description: "Forza la risoluzione dello schermo a essere un multiplo di 16 pixel." },
                ...
                DOCKER_PRIVILEGED: { label: "Modalità Privilegiata", description: "Dai tutti i permessi al container, rimuovi le restrizioni cgroup, monta tutti i dispositivi host. Questo romperà le cose!" },
                DOCKER_BIND_MOUNTS: { label: "Bind Mount Extra", description: "Bind host extra (separati da virgola, es. /host/path:/container/path:ro)." },
                DOCKER_ENV: { label: "Variabili d'Ambiente", description: "Variabili d'ambiente extra (separate da virgola, es. KEY=VALUE,KEY2=VALUE2)." },
                DOCKER_CAP_ADD: { label: "Aggiungi Cap", description: "Aggiungi capacità del kernel (separate da virgola, es. SYS_ADMIN,MKNOD)." },
                DOCKER_CAP_DROP: { label: "Rimuovi Cap", description: "Rimuovi capacità del kernel (separate da virgola)." },
                DOCKER_SECURITY_OPT: { label: "Opzioni di Sicurezza", description: "Opzioni di sicurezza (separate da virgola, es. seccomp=unconfined,apparmor=unconfined)." },
                DOCKER_DEVICES: { label: "Dispositivi", description: "Esponi dispositivi host (separati da virgola, es. /dev/sda:/dev/xvda:rwm)." },
                DOCKER_SHM_SIZE: { label: "Dimensione SHM", description: "Dimensione di /dev/shm (es. 1G, 2G)." },
                DOCKER_MEM_LIMIT: { label: "Limite Memoria", description: "Limite memoria (es. 1g, 512m)." },
                DOCKER_CPU_SHARES: { label: "Quote CPU", description: "Quote CPU (intero peso relativo)." },
                DOCKER_NANO_CPUS: { label: "Nano CPU", description: "Quota CPU in unità di 1e-9 CPU." },
                DOCKER_NETWORK_MODE: { label: "Modalità Rete", description: "Modalità di rete per il container.", options: { default: "Predefinito (Bridge)", host: "Host", none: "Nessuno", bridge: "Bridge" } },
                DOCKER_IPC_MODE: { label: "Modalità IPC", description: "Imposta la modalità IPC per il container.", options: { default: "Predefinito", host: "Host", private: "Privato", shareable: "Condivisibile" } },
                DOCKER_PID_MODE: { label: "Modalità PID", description: "Imposta la modalità PID per il container.", options: { default: "Predefinito", host: "Host" } },
                DOCKER_DNS: { label: "Server DNS", description: "Server DNS personalizzati (separati da virgola)." },
                DOCKER_EXTRA_HOSTS: { label: "Host Extra", description: "Mappature Host a IP (separate da virgola, es. hostname:1.2.3.4)." },
                DOCKER_SYSCTLS: { label: "Sysctls", description: "Parametri del kernel (separati da virgola, es. net.ipv4.ip_forward=1)." },
                DOCKER_ULIMITS: { label: "Ulimits", description: "Ulimits (separati da virgola, es. nofile=1024:1024)." },
                DOCKER_TMPFS: { label: "Mount Tmpfs", description: "Filesystem temporanei (separati da virgola, es. /run:rw,noexec,nosuid,size=65536k)." },
                DOCKER_GROUP_ADD: { label: "Aggiungi Gruppo", description: "Elenco di nomi e/o ID di gruppi aggiuntivi (separati da virgola)." },
            }
        },
        appLaboratory: {
        ...
        modals: {
            ...
            generalTitle: 'Impostazioni Generali e Prestazioni',
            dockerTitle: 'Sovrascritture Avanzate Docker',
            dockerDescription: 'Queste impostazioni sovrascrivono la configurazione predefinita del container. Usa con cautela e solo se sai cosa stai facendo.',
        },
        status: {
    ...
    options: {
        ...
        appTemplates: {
            ...
            settings: {
                ...
                SELKIES_CLIPBOARD_IN_ENABLED: { label: "Klembord van client naar server inschakelen", description: "Overdracht van klembordgegevens vanuit de browser toestaan." },
                SELKIES_CLIPBOARD_OUT_ENABLED: { label: "Klembord van server naar client inschakelen", description: "Overdracht van klembordgegevens vanuit de server toestaan." },
                ...
                SELKIES_FORCE_ALIGNED_RESOLUTION: { label: "Uitgelijnde resolutie afdwingen", description: "Dwingt de beeldschermresolutie af om een veelvoud van 16 pixels te zijn." },
                ...
                DOCKER_PRIVILEGED: { label: "Geprivilegieerde Modus", description: "Geef alle rechten aan container, hef cgroup-beperkingen op, mount alle host-apparaten. Dit zal dingen breken!" },
                DOCKER_BIND_MOUNTS: { label: "Extra Bind Mounts", description: "Extra host binds (komma-gescheiden, bijv. /host/path:/container/path:ro)." },
                DOCKER_ENV: { label: "Omgevingsvariabelen", description: "Extra omgevingsvariabelen (komma-gescheiden, bijv. KEY=VALUE,KEY2=VALUE2)." },
                DOCKER_CAP_ADD: { label: "Cap Toevoegen", description: "Kernel-capaciteiten toevoegen (komma-gescheiden, bijv. SYS_ADMIN,MKNOD)." },
                DOCKER_CAP_DROP: { label: "Cap Verwijderen", description: "Kernel-capaciteiten verwijderen (komma-gescheiden)." },
                DOCKER_SECURITY_OPT: { label: "Beveiligingsopties", description: "Beveiligingsopties (komma-gescheiden, bijv. seccomp=unconfined,apparmor=unconfined)." },
                DOCKER_DEVICES: { label: "Apparaten", description: "Host-apparaten blootstellen (komma-gescheiden, bijv. /dev/sda:/dev/xvda:rwm)." },
                DOCKER_SHM_SIZE: { label: "SHM Grootte", description: "Grootte van /dev/shm (bijv. 1G, 2G)." },
                DOCKER_MEM_LIMIT: { label: "Geheugenlimiet", description: "Geheugenlimiet (bijv. 1g, 512m)." },
                DOCKER_CPU_SHARES: { label: "CPU Aandelen", description: "CPU aandelen (relatief gewicht geheel getal)." },
                DOCKER_NANO_CPUS: { label: "Nano CPU's", description: "CPU-quotum in eenheden van 1e-9 CPU's." },
                DOCKER_NETWORK_MODE: { label: "Netwerkmodus", description: "Netwerkmodus voor de container.", options: { default: "Standaard (Bridge)", host: "Host", none: "Geen", bridge: "Bridge" } },
                DOCKER_IPC_MODE: { label: "IPC Modus", description: "Stel de IPC-modus in voor de container.", options: { default: "Standaard", host: "Host", private: "Privé", shareable: "Deelbaar" } },
                DOCKER_PID_MODE: { label: "PID Modus", description: "Stel de PID-modus in voor de container.", options: { default: "Standaard", host: "Host" } },
                DOCKER_DNS: { label: "DNS Servers", description: "Aangepaste DNS-servers (komma-gescheiden)." },
                DOCKER_EXTRA_HOSTS: { label: "Extra Hosts", description: "Host naar IP toewijzingen (komma-gescheiden, bijv. hostname:1.2.3.4)." },
                DOCKER_SYSCTLS: { label: "Sysctls", description: "Kernelparameters (komma-gescheiden, bijv. net.ipv4.ip_forward=1)." },
                DOCKER_ULIMITS: { label: "Ulimits", description: "Ulimits (komma-gescheiden, bijv. nofile=1024:1024)." },
                DOCKER_TMPFS: { label: "Tmpfs Mounts", description: "Tijdelijke bestandssystemen (komma-gescheiden, bijv. /run:rw,noexec,nosuid,size=65536k)." },
                DOCKER_GROUP_ADD: { label: "Groep Toevoegen", description: "Lijst met extra groepsnamen en/of ID's (komma-gescheiden)." },
            }
        },
        appLaboratory: {
        ...
        modals: {
            ...
            generalTitle: 'Algemene & Prestatie-instellingen',
            dockerTitle: 'Docker Geavanceerde Overschrijvingen',
            dockerDescription: 'Deze instellingen overschrijven de standaard containerconfiguratie. Gebruik met voorzichtigheid en alleen als u weet wat u doet.',
        },
        status: {
            loggingIn: 'Inloggen...',
    ...
    options: {
        ...
        appTemplates: {
            ...
            settings: {
                ...
                SELKIES_CLIPBOARD_IN_ENABLED: { label: "تمكين الحافظة من العميل إلى الخادم", description: "السماح بنقل بيانات الحافظة من المتصفح." },
                SELKIES_CLIPBOARD_OUT_ENABLED: { label: "تمكين الحافظة من الخادم إلى العميل", description: "السماح بنقل بيانات الحافظة من الخادم." },
                ...
                SELKIES_FORCE_ALIGNED_RESOLUTION: { label: "ﻑﺮﺿ ﻢﺣﺍﺫﺍﺓ ﺎﻟﺪﻗﺓ", description: "ﻲﻓﺮﺿ ﺄﻧ ﺖﻛﻮﻧ ﺪﻗﺓ ﺎﻠﻋﺮﺿ ﻢﻧ ﻢﺿﺎﻌﻓﺎﺗ 16 ﺐﻜﺴﻟ" },
                ...
                DOCKER_PRIVILEGED: { label: "الوضع المميز", description: "منح جميع الصلاحيات للحاوية، رفع قيود cgroup، تحميل جميع أجهزة المضيف. هذا قد يكسر الأشياء!" },
                DOCKER_BIND_MOUNTS: { label: "نقاط تثبيت إضافية (Bind Mounts)", description: "نقاط تثبيت مضيف إضافية (مفصولة بفاصلة، مثال: /host/path:/container/path:ro)." },
                DOCKER_ENV: { label: "متغيرات البيئة", description: "متغيرات بيئة إضافية (مفصولة بفاصلة، مثال: KEY=VALUE,KEY2=VALUE2)." },
                DOCKER_CAP_ADD: { label: "إضافة قدرة (Cap Add)", description: "إضافة قدرات النواة (مفصولة بفاصلة، مثال: SYS_ADMIN,MKNOD)." },
                DOCKER_CAP_DROP: { label: "إسقاط قدرة (Cap Drop)", description: "إسقاط قدرات النواة (مفصولة بفاصلة)." },
                DOCKER_SECURITY_OPT: { label: "خيارات الأمان", description: "خيارات الأمان (مفصولة بفاصلة، مثال: seccomp=unconfined,apparmor=unconfined)." },
                DOCKER_DEVICES: { label: "الأجهزة", description: "كشف أجهزة المضيف (مفصولة بفاصلة، مثال: /dev/sda:/dev/xvda:rwm)." },
                DOCKER_SHM_SIZE: { label: "حجم SHM", description: "حجم /dev/shm (مثال: 1G, 2G)." },
                DOCKER_MEM_LIMIT: { label: "حد الذاكرة", description: "حد الذاكرة (مثال: 1g, 512m)." },
                DOCKER_CPU_SHARES: { label: "حصص المعالج", description: "حصص المعالج (عدد صحيح للوزن النسبي)." },
                DOCKER_NANO_CPUS: { label: "Nano CPUs", description: "حصة المعالج بوحدات 1e-9 CPUs." },
                DOCKER_NETWORK_MODE: { label: "وضع الشبكة", description: "وضع الشبكة للحاوية.", options: { default: "افتراضي (Bridge)", host: "Host", none: "لا شيء", bridge: "Bridge" } },
                DOCKER_IPC_MODE: { label: "وضع IPC", description: "تعيين وضع IPC للحاوية.", options: { default: "افتراضي", host: "Host", private: "خاص", shareable: "قابل للمشاركة" } },
                DOCKER_PID_MODE: { label: "وضع PID", description: "تعيين وضع PID للحاوية.", options: { default: "افتراضي", host: "Host" } },
                DOCKER_DNS: { label: "خوادم DNS", description: "خوادم DNS مخصصة (مفصولة بفاصلة)." },
                DOCKER_EXTRA_HOSTS: { label: "مضيفون إضافيون", description: "تعيينات المضيف إلى IP (مفصولة بفاصلة، مثال: hostname:1.2.3.4)." },
                DOCKER_SYSCTLS: { label: "Sysctls", description: "معلمات النواة (مفصولة بفاصلة، مثال: net.ipv4.ip_forward=1)." },
                DOCKER_ULIMITS: { label: "Ulimits", description: "Ulimits (مفصولة بفاصلة، مثال: nofile=1024:1024)." },
                DOCKER_TMPFS: { label: "تثبيتات Tmpfs", description: "أنظمة ملفات مؤقتة (مفصولة بفاصلة، مثال: /run:rw,noexec,nosuid,size=65536k)." },
                DOCKER_GROUP_ADD: { label: "إضافة مجموعة", description: "قائمة بأسماء و/أو معرفات المجموعات الإضافية (مفصولة بفاصلة)." },
            }
        },
        appLaboratory: {
        ...
        modals: {
            ...
            generalTitle: 'إعدادات عامة والأداء',
            dockerTitle: 'تجاوزات Docker المتقدمة',
            dockerDescription: 'تتجاوز هذه الإعدادات التكوين الافتراضي للحاوية. استخدمها بحذر وفقط إذا كنت تعرف ما تفعله.',
        },
        status: {
    ...
    options: {
        ...
        appTemplates: {
            ...
            settings: {
                ...
                SELKIES_CLIPBOARD_IN_ENABLED: { label: "클라이언트에서 서버로 클립보드 활성화", description: "브라우저에서 클립보드 데이터를 전송하도록 허용합니다." },
                SELKIES_CLIPBOARD_OUT_ENABLED: { label: "서버에서 클라이언트로 클립보드 활성화", description: "서버에서 클립보드 데이터를 전송하도록 허용합니다." },
                ...
                SELKIES_FORCE_ALIGNED_RESOLUTION: { label: "정렬된 해상도 강제 적용", description: "디스플레이 해상도를 16픽셀의 배수로 강제 지정합니다." },
                ...
                DOCKER_PRIVILEGED: { label: "권한 모드", description: "컨테이너에 모든 권한 부여, cgroup 제한 해제, 모든 호스트 장치 마운트. 이 설정은 시스템을 손상시킬 수 있습니다!" },
                DOCKER_BIND_MOUNTS: { label: "추가 바인드 마운트", description: "추가 호스트 바인드 (쉼표로 구분, 예: /host/path:/container/path:ro)." },
                DOCKER_ENV: { label: "환경 변수", description: "추가 환경 변수 (쉼표로 구분, 예: KEY=VALUE,KEY2=VALUE2)." },
                DOCKER_CAP_ADD: { label: "Cap 추가", description: "커널 기능 추가 (쉼표로 구분, 예: SYS_ADMIN,MKNOD)." },
                DOCKER_CAP_DROP: { label: "Cap 제거", description: "커널 기능 제거 (쉼표로 구분)." },
                DOCKER_SECURITY_OPT: { label: "보안 옵션", description: "보안 옵션 (쉼표로 구분, 예: seccomp=unconfined,apparmor=unconfined)." },
                DOCKER_DEVICES: { label: "장치", description: "호스트 장치 노출 (쉼표로 구분, 예: /dev/sda:/dev/xvda:rwm)." },
                DOCKER_SHM_SIZE: { label: "SHM 크기", description: "/dev/shm의 크기 (예: 1G, 2G)." },
                DOCKER_MEM_LIMIT: { label: "메모리 제한", description: "메모리 제한 (예: 1g, 512m)." },
                DOCKER_CPU_SHARES: { label: "CPU 공유", description: "CPU 공유 (상대적 가중치 정수)." },
                DOCKER_NANO_CPUS: { label: "Nano CPU", description: "1e-9 CPU 단위의 CPU 할당량." },
                DOCKER_NETWORK_MODE: { label: "네트워크 모드", description: "컨테이너의 네트워킹 모드.", options: { default: "기본값 (Bridge)", host: "Host", none: "없음", bridge: "Bridge" } },
                DOCKER_IPC_MODE: { label: "IPC 모드", description: "컨테이너의 IPC 모드 설정.", options: { default: "기본값", host: "Host", private: "비공개", shareable: "공유 가능" } },
                DOCKER_PID_MODE: { label: "PID 모드", description: "컨테이너의 PID 모드 설정.", options: { default: "기본값", host: "Host" } },
                DOCKER_DNS: { label: "DNS 서버", description: "사용자 지정 DNS 서버 (쉼표로 구분)." },
                DOCKER_EXTRA_HOSTS: { label: "추가 호스트", description: "호스트 대 IP 매핑 (쉼표로 구분, 예: hostname:1.2.3.4)." },
                DOCKER_SYSCTLS: { label: "Sysctls", description: "커널 매개변수 (쉼표로 구분, 예: net.ipv4.ip_forward=1)." },
                DOCKER_ULIMITS: { label: "Ulimits", description: "Ulimits (쉼표로 구분, 예: nofile=1024:1024)." },
                DOCKER_TMPFS: { label: "Tmpfs 마운트", description: "임시 파일 시스템 (쉼표로 구분, 예: /run:rw,noexec,nosuid,size=65536k)." },
                DOCKER_GROUP_ADD: { label: "그룹 추가", description: "추가 그룹 이름 및/또는 ID 목록 (쉼표로 구분)." },
            }
        },
        appLaboratory: {
            title: '앱 실험실',
        ...
        modals: {
            ...
            generalTitle: '일반 및 성능 설정',
            dockerTitle: 'Docker 고급 재정의',
            dockerDescription: '이 설정은 기본 컨테이너 구성을 재정의합니다. 주의해서 사용하고 수행 중인 작업을 알고 있는 경우에만 사용하십시오.',
        },
        status: {
            loggingIn: '로그인 중...',
    ...
    options: {
        ...
        appTemplates: {
            ...
            settings: {
                ...
                SELKIES_CLIPBOARD_IN_ENABLED: { label: "クライアントからサーバーへのクリップボードを有効化", description: "ブラウザからのクリップボードデータの転送を許可します。" },
                SELKIES_CLIPBOARD_OUT_ENABLED: { label: "サーバーからクライアントへのクリップボードを有効化", description: "サーバーからのクリップボードデータの転送を許可します。" },
                ...
                SELKIES_FORCE_ALIGNED_RESOLUTION: { label: "整列された解像度を強制", description: "ディスプレイの解像度を16ピクセルの倍数に強制します." },
                ...
                DOCKER_PRIVILEGED: { label: "特権モード", description: "コンテナにすべての権限を与え、cgroup制限を解除し、すべてのホストデバイスをマウントします。これにより問題が発生する可能性があります！" },
                DOCKER_BIND_MOUNTS: { label: "追加のバインドマウント", description: "追加のホストバインド（カンマ区切り、例：/host/path:/container/path:ro）。" },
                DOCKER_ENV: { label: "環境変数", description: "追加の環境変数（カンマ区切り、例：KEY=VALUE,KEY2=VALUE2）。" },
                DOCKER_CAP_ADD: { label: "Cap追加", description: "カーネル機能を追加（カンマ区切り、例：SYS_ADMIN,MKNOD）。" },
                DOCKER_CAP_DROP: { label: "Cap削除", description: "カーネル機能を削除（カンマ区切り）。" },
                DOCKER_SECURITY_OPT: { label: "セキュリティオプション", description: "セキュリティオプション（カンマ区切り、例：seccomp=unconfined,apparmor=unconfined）。" },
                DOCKER_DEVICES: { label: "デバイス", description: "ホストデバイスを公開（カンマ区切り、例：/dev/sda:/dev/xvda:rwm）。" },
                DOCKER_SHM_SIZE: { label: "SHMサイズ", description: "/dev/shmのサイズ（例：1G, 2G）。" },
                DOCKER_MEM_LIMIT: { label: "メモリ制限", description: "メモリ制限（例：1g, 512m）。" },
                DOCKER_CPU_SHARES: { label: "CPUシェア", description: "CPUシェア（相対的な重みの整数）。" },
                DOCKER_NANO_CPUS: { label: "Nano CPU", description: "1e-9 CPU単位のCPUクォータ。" },
                DOCKER_NETWORK_MODE: { label: "ネットワークモード", description: "コンテナのネットワークモード。", options: { default: "デフォルト (Bridge)", host: "Host", none: "なし", bridge: "Bridge" } },
                DOCKER_IPC_MODE: { label: "IPCモード", description: "コンテナのIPCモードを設定します。", options: { default: "デフォルト", host: "Host", private: "プライベート", shareable: "共有可能" } },
                DOCKER_PID_MODE: { label: "PIDモード", description: "コンテナのPIDモードを設定します。", options: { default: "デフォルト", host: "Host" } },
                DOCKER_DNS: { label: "DNSサーバー", description: "カスタムDNSサーバー（カンマ区切り）。" },
                DOCKER_EXTRA_HOSTS: { label: "追加ホスト", description: "ホストとIPのマッピング（カンマ区切り、例：hostname:1.2.3.4）。" },
                DOCKER_SYSCTLS: { label: "Sysctls", description: "カーネルパラメータ（カンマ区切り、例：net.ipv4.ip_forward=1）。" },
                DOCKER_ULIMITS: { label: "Ulimits", description: "Ulimits（カンマ区切り、例：nofile=1024:1024）。" },
                DOCKER_TMPFS: { label: "Tmpfsマウント", description: "一時ファイルシステム（カンマ区切り、例：/run:rw,noexec,nosuid,size=65536k）。" },
                DOCKER_GROUP_ADD: { label: "グループ追加", description: "追加のグループ名および/またはIDのリスト（カンマ区切り）。" },
            }
        },
        appLaboratory: {
            title: 'アプリラボ',
        ...
        modals: {
            ...
            generalTitle: '一般とパフォーマンス設定',
            dockerTitle: 'Docker詳細オーバーライド',
            dockerDescription: 'これらの設定は、デフォルトのコンテナ構成を上書きします。注意して使用し、何をしているか理解している場合にのみ使用してください。',
        },
        status: {
            loggingIn: 'ログイン中...',
    ...
    options: {
        ...
        appTemplates: {
            ...
            settings: {
                ...
                SELKIES_CLIPBOARD_IN_ENABLED: { label: "Bật khay nhớ tạm từ máy khách sang máy chủ", description: "Cho phép truyền dữ liệu khay nhớ tạm từ trình duyệt." },
                SELKIES_CLIPBOARD_OUT_ENABLED: { label: "Bật khay nhớ tạm từ máy chủ sang máy khách", description: "Cho phép truyền dữ liệu khay nhớ tạm từ máy chủ." },
                ...
                SELKIES_FORCE_ALIGNED_RESOLUTION: { label: "Bắt buộc độ phân giải căn chỉnh", description: "Bắt buộc độ phân giải màn hình phải là bội số của 16 pixel." },
                ...
                DOCKER_PRIVILEGED: { label: "Chế độ đặc quyền", description: "Cấp mọi quyền cho container, gỡ bỏ giới hạn cgroup, gắn kết tất cả thiết bị máy chủ. Điều này sẽ gây lỗi hệ thống!" },
                DOCKER_BIND_MOUNTS: { label: "Gắn kết Bind bổ sung", description: "Các gắn kết máy chủ bổ sung (phân tách bằng dấu phẩy, ví dụ: /host/path:/container/path:ro)." },
                DOCKER_ENV: { label: "Biến môi trường", description: "Các biến môi trường bổ sung (phân tách bằng dấu phẩy, ví dụ: KEY=VALUE,KEY2=VALUE2)." },
                DOCKER_CAP_ADD: { label: "Thêm Cap", description: "Thêm khả năng kernel (phân tách bằng dấu phẩy, ví dụ: SYS_ADMIN,MKNOD)." },
                DOCKER_CAP_DROP: { label: "Bỏ Cap", description: "Bỏ khả năng kernel (phân tách bằng dấu phẩy)." },
                DOCKER_SECURITY_OPT: { label: "Tùy chọn bảo mật", description: "Các tùy chọn bảo mật (phân tách bằng dấu phẩy, ví dụ: seccomp=unconfined,apparmor=unconfined)." },
                DOCKER_DEVICES: { label: "Thiết bị", description: "Hiển thị thiết bị máy chủ (phân tách bằng dấu phẩy, ví dụ: /dev/sda:/dev/xvda:rwm)." },
                DOCKER_SHM_SIZE: { label: "Kích thước SHM", description: "Kích thước của /dev/shm (ví dụ: 1G, 2G)." },
                DOCKER_MEM_LIMIT: { label: "Giới hạn bộ nhớ", description: "Giới hạn bộ nhớ (ví dụ: 1g, 512m)." },
                DOCKER_CPU_SHARES: { label: "Chia sẻ CPU", description: "Chia sẻ CPU (số nguyên trọng số tương đối)." },
                DOCKER_NANO_CPUS: { label: "Nano CPU", description: "Hạn ngạch CPU tính bằng đơn vị 1e-9 CPU." },
                DOCKER_NETWORK_MODE: { label: "Chế độ mạng", description: "Chế độ mạng cho container.", options: { default: "Mặc định (Bridge)", host: "Host", none: "Không", bridge: "Bridge" } },
                DOCKER_IPC_MODE: { label: "Chế độ IPC", description: "Đặt chế độ IPC cho container.", options: { default: "Mặc định", host: "Host", private: "Riêng tư", shareable: "Có thể chia sẻ" } },
                DOCKER_PID_MODE: { label: "Chế độ PID", description: "Đặt chế độ PID cho container.", options: { default: "Mặc định", host: "Host" } },
                DOCKER_DNS: { label: "Máy chủ DNS", description: "Máy chủ DNS tùy chỉnh (phân tách bằng dấu phẩy)." },
                DOCKER_EXTRA_HOSTS: { label: "Máy chủ bổ sung", description: "Ánh xạ máy chủ sang IP (phân tách bằng dấu phẩy, ví dụ: hostname:1.2.3.4)." },
                DOCKER_SYSCTLS: { label: "Sysctls", description: "Tham số kernel (phân tách bằng dấu phẩy, ví dụ: net.ipv4.ip_forward=1)." },
                DOCKER_ULIMITS: { label: "Ulimits", description: "Ulimits (phân tách bằng dấu phẩy, ví dụ: nofile=1024:1024)." },
                DOCKER_TMPFS: { label: "Gắn kết Tmpfs", description: "Hệ thống tệp tạm thời (phân tách bằng dấu phẩy, ví dụ: /run:rw,noexec,nosuid,size=65536k)." },
                DOCKER_GROUP_ADD: { label: "Thêm nhóm", description: "Danh sách tên nhóm và/hoặc ID bổ sung (phân tách bằng dấu phẩy)." },
            }
        },
        appLaboratory: {
        ...
        modals: {
            ...
            generalTitle: 'Cài đặt Chung & Hiệu suất',
            dockerTitle: 'Ghi đè nâng cao Docker',
            dockerDescription: 'Các cài đặt này ghi đè cấu hình container mặc định. Sử dụng thận trọng và chỉ khi bạn biết mình đang làm gì.',
        },
        status: {
    ...
    options: {
        ...
        appTemplates: {
            ...
            settings: {
                ...
                SELKIES_CLIPBOARD_IN_ENABLED: { label: "เปิดใช้งานคลิปบอร์ดจากไคลเอนต์ไปยังเซิร์ฟเวอร์", description: "อนุญาตให้ถ่ายโอนข้อมูลคลิปบอร์ดจากเบราว์เซอร์" },
                SELKIES_CLIPBOARD_OUT_ENABLED: { label: "เปิดใช้งานคลิปบอร์ดจากเซิร์ฟเวอร์ไปยังไคลเอนต์", description: "อนุญาตให้ถ่ายโอนข้อมูลคลิปบอร์ดจากเซิร์ฟเวอร์" },
                ...
                SELKIES_FORCE_ALIGNED_RESOLUTION: { label: "บังคับความละเอียดที่จัดตำแหน่ง", description: "บังคับให้ความละเอียดของจอแสดงผลเป็นผลคูณของ 16 พิกเซล." },
                ...
                DOCKER_PRIVILEGED: { label: "โหมดสิทธิ์พิเศษ", description: "ให้สิทธิ์ทั้งหมดแก่คอนเทนเนอร์ ยกเลิกข้อจำกัด cgroup เมาท์อุปกรณ์โฮสต์ทั้งหมด การทำเช่นนี้จะทำให้ระบบเสียหาย!" },
                DOCKER_BIND_MOUNTS: { label: "Bind Mounts เพิ่มเติม", description: "การผูกโฮสต์เพิ่มเติม (คั่นด้วยจุลภาค เช่น /host/path:/container/path:ro)" },
                DOCKER_ENV: { label: "ตัวแปรสภาพแวดล้อม", description: "ตัวแปรสภาพแวดล้อมเพิ่มเติม (คั่นด้วยจุลภาค เช่น KEY=VALUE,KEY2=VALUE2)" },
                DOCKER_CAP_ADD: { label: "เพิ่ม Cap", description: "เพิ่มความสามารถของเคอร์เนล (คั่นด้วยจุลภาค เช่น SYS_ADMIN,MKNOD)" },
                DOCKER_CAP_DROP: { label: "ลบ Cap", description: "ลบความสามารถของเคอร์เนล (คั่นด้วยจุลภาค)" },
                DOCKER_SECURITY_OPT: { label: "ตัวเลือกความปลอดภัย", description: "ตัวเลือกความปลอดภัย (คั่นด้วยจุลภาค เช่น seccomp=unconfined,apparmor=unconfined)" },
                DOCKER_DEVICES: { label: "อุปกรณ์", description: "เปิดเผยอุปกรณ์โฮสต์ (คั่นด้วยจุลภาค เช่น /dev/sda:/dev/xvda:rwm)" },
                DOCKER_SHM_SIZE: { label: "ขนาด SHM", description: "ขนาดของ /dev/shm (เช่น 1G, 2G)" },
                DOCKER_MEM_LIMIT: { label: "ขีดจำกัดหน่วยความจำ", description: "ขีดจำกัดหน่วยความจำ (เช่น 1g, 512m)" },
                DOCKER_CPU_SHARES: { label: "ส่วนแบ่ง CPU", description: "ส่วนแบ่ง CPU (จำนวนเต็มน้ำหนักสัมพัทธ์)" },
                DOCKER_NANO_CPUS: { label: "Nano CPUs", description: "โควตา CPU ในหน่วย 1e-9 CPUs" },
                DOCKER_NETWORK_MODE: { label: "โหมดเครือข่าย", description: "โหมดเครือข่ายสำหรับคอนเทนเนอร์", options: { default: "ค่าเริ่มต้น (Bridge)", host: "Host", none: "ไม่มี", bridge: "Bridge" } },
                DOCKER_IPC_MODE: { label: "โหมด IPC", description: "ตั้งค่าโหมด IPC สำหรับคอนเทนเนอร์", options: { default: "ค่าเริ่มต้น", host: "Host", private: "ส่วนตัว", shareable: "แชร์ได้" } },
                DOCKER_PID_MODE: { label: "โหมด PID", description: "ตั้งค่าโหมด PID สำหรับคอนเทนเนอร์", options: { default: "ค่าเริ่มต้น", host: "Host" } },
                DOCKER_DNS: { label: "เซิร์ฟเวอร์ DNS", description: "เซิร์ฟเวอร์ DNS ที่กำหนดเอง (คั่นด้วยจุลภาค)" },
                DOCKER_EXTRA_HOSTS: { label: "โฮสต์เพิ่มเติม", description: "การแมปโฮสต์กับ IP (คั่นด้วยจุลภาค เช่น hostname:1.2.3.4)" },
                DOCKER_SYSCTLS: { label: "Sysctls", description: "พารามิเตอร์เคอร์เนล (คั่นด้วยจุลภาค เช่น net.ipv4.ip_forward=1)" },
                DOCKER_ULIMITS: { label: "Ulimits", description: "Ulimits (คั่นด้วยจุลภาค เช่น nofile=1024:1024)" },
                DOCKER_TMPFS: { label: "Tmpfs Mounts", description: "ระบบไฟล์ชั่วคราว (คั่นด้วยจุลภาค เช่น /run:rw,noexec,nosuid,size=65536k)" },
                DOCKER_GROUP_ADD: { label: "เพิ่มกลุ่ม", description: "รายการชื่อกลุ่มและ/หรือ ID เพิ่มเติม (คั่นด้วยจุลภาค)" },
            }
        },
        appLaboratory: {
        ...
        modals: {
            ...
            generalTitle: 'การตั้งค่าทั่วไปและประสิทธิภาพ',
            dockerTitle: 'การแทนที่ขั้นสูงของ Docker',
            dockerDescription: 'การตั้งค่าเหล่านี้จะแทนที่การกำหนดค่าคอนเทนเนอร์เริ่มต้น โปรดใช้ด้วยความระมัดระวังและเฉพาะในกรณีที่คุณรู้ว่ากำลังทำอะไรอยู่',
        },
        status: {
    ...
    options: {
        ...
        appTemplates: {
            ...
            settings: {
                ...
                SELKIES_CLIPBOARD_IN_ENABLED: { label: "Paganahin ang Clipboard mula Client papuntang Server", description: "Payagan ang paglilipat ng data ng clipboard mula sa browser." },
                SELKIES_CLIPBOARD_OUT_ENABLED: { label: "Paganahin ang Clipboard mula Server papuntang Client", description: "Payagan ang paglilipat ng data ng clipboard mula sa server." },
                ...
                SELKIES_FORCE_ALIGNED_RESOLUTION: { label: "Ipilit ang Nakahanay na Resolusyon", description: "Ipinipilit na ang resolusyon ng display ay maging multiple ng 16 pixels." },
                ...
                DOCKER_PRIVILEGED: { label: "Privileged Mode", description: "Ibigay ang lahat ng caps sa container, alisin ang mga paghihigpit sa cgroup, i-mount ang lahat ng host device. Masisira nito ang mga bagay!" },
                DOCKER_BIND_MOUNTS: { label: "Karagdagang Bind Mounts", description: "Karagdagang host binds (pinaghihiwalay ng kuwit, hal., /host/path:/container/path:ro)." },
                DOCKER_ENV: { label: "Mga Variable ng Kapaligiran", description: "Karagdagang environment variables (pinaghihiwalay ng kuwit, hal., KEY=VALUE,KEY2=VALUE2)." },
                DOCKER_CAP_ADD: { label: "Magdagdag ng Cap", description: "Magdagdag ng kernel capabilities (pinaghihiwalay ng kuwit, hal., SYS_ADMIN,MKNOD)." },
                DOCKER_CAP_DROP: { label: "Mag-drop ng Cap", description: "Mag-drop ng kernel capabilities (pinaghihiwalay ng kuwit)." },
                DOCKER_SECURITY_OPT: { label: "Mga Opsyon sa Seguridad", description: "Mga opsyon sa seguridad (pinaghihiwalay ng kuwit, hal., seccomp=unconfined,apparmor=unconfined)." },
                DOCKER_DEVICES: { label: "Mga Device", description: "I-expose ang mga host device (pinaghihiwalay ng kuwit, hal., /dev/sda:/dev/xvda:rwm)." },
                DOCKER_SHM_SIZE: { label: "Laki ng SHM", description: "Laki ng /dev/shm (hal. 1G, 2G)." },
                DOCKER_MEM_LIMIT: { label: "Limitasyon ng Memorya", description: "Limitasyon ng memorya (hal. 1g, 512m)." },
                DOCKER_CPU_SHARES: { label: "Mga Bahagi ng CPU", description: "Mga bahagi ng CPU (relative weight integer)." },
                DOCKER_NANO_CPUS: { label: "Nano CPUs", description: "CPU quota sa mga unit ng 1e-9 CPUs." },
                DOCKER_NETWORK_MODE: { label: "Mode ng Network", description: "Networking mode para sa container.", options: { default: "Default (Bridge)", host: "Host", none: "Wala", bridge: "Bridge" } },
                DOCKER_IPC_MODE: { label: "Mode ng IPC", description: "Itakda ang IPC mode para sa container.", options: { default: "Default", host: "Host", private: "Pribado", shareable: "Maibabahagi" } },
                DOCKER_PID_MODE: { label: "Mode ng PID", description: "Itakda ang PID mode para sa container.", options: { default: "Default", host: "Host" } },
                DOCKER_DNS: { label: "Mga DNS Server", description: "Mga pasadyang DNS server (pinaghihiwalay ng kuwit)." },
                DOCKER_EXTRA_HOSTS: { label: "Mga Karagdagang Host", description: "Host to IP mappings (pinaghihiwalay ng kuwit, hal., hostname:1.2.3.4)." },
                DOCKER_SYSCTLS: { label: "Sysctls", description: "Kernel parameters (pinaghihiwalay ng kuwit, hal., net.ipv4.ip_forward=1)." },
                DOCKER_ULIMITS: { label: "Ulimits", description: "Ulimits (pinaghihiwalay ng kuwit, hal., nofile=1024:1024)." },
                DOCKER_TMPFS: { label: "Tmpfs Mounts", description: "Pansamantalang filesystems (pinaghihiwalay ng kuwit, hal., /run:rw,noexec,nosuid,size=65536k)." },
                DOCKER_GROUP_ADD: { label: "Magdagdag ng Grupo", description: "Listahan ng karagdagang mga pangalan at/o ID ng grupo (pinaghihiwalay ng kuwit)." },
            }
        },
        appLaboratory: {
        ...
        modals: {
            ...
            generalTitle: 'Pangkalahatan at Pagganap na mga Setting',
            dockerTitle: 'Mga Advanced na Pag-override ng Docker',
            dockerDescription: 'Ang mga setting na ito ay nag-o-override sa default na configuration ng container. Gamitin nang may pag-iingat at kung alam mo lang ang iyong ginagawa.',
        },
        status: {
    ...
    options: {
        ...
        appTemplates: {
            ...
            settings: {
                ...
                SELKIES_CLIPBOARD_IN_ENABLED: { label: "Aktiver udklipsholder fra klient til server", description: "Tillad overførsel af udklipsholderdata fra browseren." },
                SELKIES_CLIPBOARD_OUT_ENABLED: { label: "Aktiver udklipsholder fra server til klient", description: "Tillad overførsel af udklipsholderdata fra serveren." },
                ...
                SELKIES_FORCE_ALIGNED_RESOLUTION: { label: "Gennemtving justeret opløsning", description: "Gennemtvinger skærmopløsningen til at være et multiplum af 16 pixels." },
                ...
                DOCKER_PRIVILEGED: { label: "Priviligeret Tilstand", description: "Giv alle rettigheder til container, ophæv cgroup-begrænsninger, monter alle værtsenheder. Dette vil ødelægge ting!" },
                DOCKER_BIND_MOUNTS: { label: "Ekstra Bind Mounts", description: "Ekstra værtsbindinger (kommasepareret, f.eks., /host/path:/container/path:ro)." },
                DOCKER_ENV: { label: "Miljøvariabler", description: "Ekstra miljøvariabler (kommasepareret, f.eks., KEY=VALUE,KEY2=VALUE2)." },
                DOCKER_CAP_ADD: { label: "Tilføj Cap", description: "Tilføj kernefunktioner (kommasepareret, f.eks., SYS_ADMIN,MKNOD)." },
                DOCKER_CAP_DROP: { label: "Fjern Cap", description: "Fjern kernefunktioner (kommasepareret)." },
                DOCKER_SECURITY_OPT: { label: "Sikkerhedsindstillinger", description: "Sikkerhedsindstillinger (kommasepareret, f.eks., seccomp=unconfined,apparmor=unconfined)." },
                DOCKER_DEVICES: { label: "Enheder", description: "Eksponer værtsenheder (kommasepareret, f.eks., /dev/sda:/dev/xvda:rwm)." },
                DOCKER_SHM_SIZE: { label: "SHM Størrelse", description: "Størrelse af /dev/shm (f.eks. 1G, 2G)." },
                DOCKER_MEM_LIMIT: { label: "Hukommelsesgrænse", description: "Hukommelsesgrænse (f.eks. 1g, 512m)." },
                DOCKER_CPU_SHARES: { label: "CPU Andele", description: "CPU andele (relativ vægt heltal)." },
                DOCKER_NANO_CPUS: { label: "Nano CPU'er", description: "CPU-kvote i enheder af 1e-9 CPU'er." },
                DOCKER_NETWORK_MODE: { label: "Netværkstilstand", description: "Netværkstilstand for containeren.", options: { default: "Standard (Bridge)", host: "Host", none: "Ingen", bridge: "Bridge" } },
                DOCKER_IPC_MODE: { label: "IPC Tilstand", description: "Indstil IPC-tilstand for containeren.", options: { default: "Standard", host: "Host", private: "Privat", shareable: "Delbar" } },
                DOCKER_PID_MODE: { label: "PID Tilstand", description: "Indstil PID-tilstand for containeren.", options: { default: "Standard", host: "Host" } },
                DOCKER_DNS: { label: "DNS Servere", description: "Brugerdefinerede DNS-servere (kommasepareret)." },
                DOCKER_EXTRA_HOSTS: { label: "Ekstra Værter", description: "Vært til IP-kortlægninger (kommasepareret, f.eks., hostname:1.2.3.4)." },
                DOCKER_SYSCTLS: { label: "Sysctls", description: "Kerneparametre (kommasepareret, f.eks., net.ipv4.ip_forward=1)." },
                DOCKER_ULIMITS: { label: "Ulimits", description: "Ulimits (kommasepareret, f.eks., nofile=1024:1024)." },
                DOCKER_TMPFS: { label: "Tmpfs Mounts", description: "Midlertidige filsystemer (kommasepareret, f.eks., /run:rw,noexec,nosuid,size=65536k)." },
                DOCKER_GROUP_ADD: { label: "Tilføj Gruppe", description: "Liste over yderligere gruppenavne og/eller ID'er (kommasepareret)." },
            }
        },
        appLaboratory: {
            title: 'App-laboratorium',
        ...
        modals: {
            ...
            generalTitle: 'Generelle & Ydelsesindstillinger',
            dockerTitle: 'Docker Avancerede Tilsidesættelser',
            dockerDescription: 'Disse indstillinger tilsidesætter standard containerkonfigurationen. Brug med forsigtighed og kun hvis du ved, hvad du gør.',
        },
        status: {
